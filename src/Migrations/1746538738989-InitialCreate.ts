...
export class InitialCreate1746538738989 implements MigrationInterface {
    name = 'InitialCreate1746538738989'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "cours" ("id_parcours" integer NOT NULL, "id_niveau" character varying NOT NULL, "id_matiere" integer NOT NULL, "id_salle" character varying NOT NULL, "cours_debut" TIMESTAMP NOT NULL, "cours_fin" TIMESTAMP NOT NULL, "status" integer NOT NULL DEFAULT '0', "qrCodeToken" character varying NOT NULL, "classeIdParcours" integer, "classeIdNiveau" character varying, "salleIdSalle" character varying, CONSTRAINT "UQ_f955ba0e910d5219640463b2276" UNIQUE ("qrCodeToken"), CONSTRAINT "PK_193b84faee203ec48c4dfd3c0ef" PRIMARY KEY ("id_parcours", "id_niveau", "id_matiere", "id_salle", "cours_debut"))`);
        ...
        await queryRunner.query(`CREATE TABLE "classe" ("id_parcours" integer NOT NULL, "id_niveau" character varying NOT NULL, "groupe" integer NOT NULL, "parcoursIdParcours" integer, "niveauIdNiveau" character varying, "matiereIdMatiere" integer, CONSTRAINT "PK_cae6abb33f2a7e1517e3d3252cc" PRIMARY KEY ("id_parcours", "id_niveau"))`);
        ...
        await queryRunner.query(`ALTER TABLE "classe" ADD CONSTRAINT "FK_6663653f01bbe74200b4e08a2c8" FOREIGN KEY ("matiereIdMatiere") REFERENCES "matiere"("id_matiere") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "classe" DROP CONSTRAINT "FK_6663653f01bbe74200b4e08a2c8"`);
