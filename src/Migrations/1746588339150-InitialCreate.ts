...
export class InitialCreate1746588339150 implements MigrationInterface {
    name = 'InitialCreate1746588339150'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "cours" ("id_parcours" integer NOT NULL, "id_niveau" character varying NOT NULL, "id_matiere" integer NOT NULL, "id_salle" character varying NOT NULL, "cours_debut" TIMESTAMP NOT NULL, "cours_fin" TIMESTAMP NOT NULL, "status" integer NOT NULL DEFAULT '0', "qrCodeToken" character varying NOT NULL, "classeIdParcours" integer, "classeIdNiveau" character varying, "classeGroupe" integer, "salleIdSalle" character varying, CONSTRAINT "UQ_f955ba0e910d5219640463b2276" UNIQUE ("qrCodeToken"), CONSTRAINT "PK_193b84faee203ec48c4dfd3c0ef" PRIMARY KEY ("id_parcours", "id_niveau", "id_matiere", "id_salle", "cours_debut"))`);
        ...
        await queryRunner.query(`ALTER TABLE "cours" ADD CONSTRAINT "FK_d49de611b08498be2f1905d2e87" FOREIGN KEY ("classeIdParcours", "classeIdNiveau", "classeGroupe") REFERENCES "classe"("id_parcours","id_niveau","groupe") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "cours" DROP CONSTRAINT "FK_d49de611b08498be2f1905d2e87"`);
